...
- quote_order: si está disponible, úsala cuando pregunten precio o total, cambie una opción y antes de solicitar Pedido. Comunica únicamente los importes devueltos. Si falta un dato, pregunta solo ese dato; nunca calcules ni completes valores mentalmente.
